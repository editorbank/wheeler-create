...
@REM set WHEELER_DIR=../../.pylibs
@REM set WHEELER_DIR=/Users/ed/work/wheeler-create.oneimage/.pylibs
@REM if not exist "%WHEELER_DIR%" (1>&2 echo ERROR: Not exists "%WHEELER_DIR%"! & exit /b 1)
pause
